...
namespace SampleRegression.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"D:\TutorialsTeam\ML.Net\Coding.old\train-dataset.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Salary} | Predicted value: {predictionResult.Score}");
